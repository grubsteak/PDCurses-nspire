...
static PDC_bool mouse_avail = PDC_FALSE, mouse_vis = PDC_FALSE, mouse_moved = PDC_FALSE,
            mouse_button = PDC_FALSE, key_pressed = PDC_FALSE;
