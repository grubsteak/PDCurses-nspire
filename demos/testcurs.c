...
void inputTest(WINDOW *win)
{
    ...
    PDC_save_key_modifiers(PDC_TRUE);
    PDC_return_key_modifiers(PDC_TRUE);
#endif
...
#ifdef PDCURSES
    mouse_set(0L);
    PDC_save_key_modifiers(PDC_FALSE);
    PDC_return_key_modifiers(PDC_FALSE);
#endif
    wclear(win);
...
void outputTest(WINDOW *win)
{
    ...
    else
    {
        ...
        copywin(win, win1, 0, 0, 0, 0, 9, 49, PDC_TRUE);
