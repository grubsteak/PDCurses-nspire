...
/*man-start**************************************************************
  ...
  Synopsis:
        ...
        int PDC_save_key_modifiers(PDC_bool flag);
        int PDC_return_key_modifiers(PDC_bool flag);
  ...
  Description:
        ...
        If keypad() is PDC_TRUE, and a function key is pressed, the token for
        that function key will be returned instead of the raw characters.
        Possible function keys are defined in <curses.h> with integers
        beginning with 0401, whose names begin with KEY_.

        If nodelay(win, PDC_TRUE) has been called on the window and no input
        ...
        call, if PDC_save_key_modifiers(PDC_TRUE) has been called before the 
