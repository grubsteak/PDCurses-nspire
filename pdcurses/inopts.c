...
/*man-start**************************************************************
  ...
  Synopsis:
        ...
        int intrflush(WINDOW *win, PDC_bool bf);
        int keypad(WINDOW *win, PDC_bool bf);
        int meta(WINDOW *win, PDC_bool bf);
        int nl(void);
        int nonl(void);
        int nodelay(WINDOW *win, PDC_bool bf);
        int notimeout(WINDOW *win, PDC_bool bf);
        int raw(void);
        int noraw(void);
        void noqiflush(void);
        void qiflush(void);
...
int nodelay(WINDOW *win, PDC_bool flag)
{
...
int notimeout(WINDOW *win, PDC_bool flag)
{
...
int raw(void)
{
    ...
    PDC_set_keyboard_binary(PDC_TRUE);
    SP->raw_inp = PDC_TRUE;
...
int noraw(void)
{
    ...
    PDC_set_keyboard_binary(PDC_FALSE);
    SP->raw_inp = PDC_FALSE;
